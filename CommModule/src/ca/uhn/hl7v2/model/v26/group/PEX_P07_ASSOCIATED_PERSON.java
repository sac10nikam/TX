...
public class PEX_P07_ASSOCIATED_PERSON extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PEX_P07_ASSOCIATED_PERSON - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PEX_P07_ASSOCIATED_RX_ADMIN> getASSOCIATED_RX_ADMINAll() throws HL7Exception {
