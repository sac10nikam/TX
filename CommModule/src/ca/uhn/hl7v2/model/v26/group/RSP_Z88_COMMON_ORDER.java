...
public class RSP_Z88_COMMON_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RSP_Z88_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RSP_Z88_TIMING> getTIMINGAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<RSP_Z88_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
