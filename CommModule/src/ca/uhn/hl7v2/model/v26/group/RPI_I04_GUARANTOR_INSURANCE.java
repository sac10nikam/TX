...
public class RPI_I04_GUARANTOR_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RPI_I04_GUARANTOR_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RPI_I04_INSURANCE> getINSURANCEAll() throws HL7Exception {
