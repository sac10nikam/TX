...
public class ORB_O28_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating ORB_O28_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<ORB_O28_TIMING> getTIMINGAll() throws HL7Exception {
