...
public class OUL_R24_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OUL_R24_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OUL_R24_VISIT getVISIT() { 
       OUL_R24_VISIT retVal = getTyped("VISIT", OUL_R24_VISIT.class);
       return retVal;
    }
