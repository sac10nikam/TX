...
public class OML_O35_PRIOR_RESULT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OML_O35_PRIOR_RESULT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<OML_O35_ORDER_PRIOR> getORDER_PRIORAll() throws HL7Exception {
