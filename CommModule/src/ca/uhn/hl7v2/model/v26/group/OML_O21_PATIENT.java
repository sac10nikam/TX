...
public class OML_O21_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OML_O21_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<OML_O21_INSURANCE> getINSURANCEAll() throws HL7Exception {
