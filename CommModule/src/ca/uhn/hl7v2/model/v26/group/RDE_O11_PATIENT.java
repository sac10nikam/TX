...
public class RDE_O11_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RDE_O11_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RDE_O11_INSURANCE> getINSURANCEAll() throws HL7Exception {
