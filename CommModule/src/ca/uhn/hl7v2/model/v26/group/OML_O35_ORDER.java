...
public class OML_O35_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          ...
                          this.add(OML_O35_TIMING.class, false, true);
          ...
          Log.e(Constants.TAG, "Unexpected error creating OML_O35_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
