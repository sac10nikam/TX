...
public class PPT_PCL_ORDER_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PPT_PCL_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PPT_PCL_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
