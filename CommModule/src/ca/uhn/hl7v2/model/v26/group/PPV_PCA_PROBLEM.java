...
public class PPV_PCA_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PPV_PCA_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PPV_PCA_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PPV_PCA_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
