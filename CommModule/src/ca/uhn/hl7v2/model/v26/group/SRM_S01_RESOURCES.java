...
public class SRM_S01_RESOURCES extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating SRM_S01_RESOURCES - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<SRM_S01_SERVICE> getSERVICEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<SRM_S01_GENERAL_RESOURCE> getGENERAL_RESOURCEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<SRM_S01_LOCATION_RESOURCE> getLOCATION_RESOURCEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<SRM_S01_PERSONNEL_RESOURCE> getPERSONNEL_RESOURCEAll() throws HL7Exception {
