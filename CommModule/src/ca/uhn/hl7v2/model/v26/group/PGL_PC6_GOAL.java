...
public class PGL_PC6_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PGL_PC6_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PGL_PC6_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PGL_PC6_PATHWAY> getPATHWAYAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PGL_PC6_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PGL_PC6_PROBLEM> getPROBLEMAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PGL_PC6_ORDER> getORDERAll() throws HL7Exception {
