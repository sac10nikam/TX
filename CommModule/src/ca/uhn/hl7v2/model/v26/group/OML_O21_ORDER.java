...
public class OML_O21_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          ...
                          this.add(OML_O21_TIMING.class, false, true);
          ...
          Log.e(Constants.TAG, "Unexpected error creating OML_O21_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<OML_O21_TIMING> getTIMINGAll() throws HL7Exception {
