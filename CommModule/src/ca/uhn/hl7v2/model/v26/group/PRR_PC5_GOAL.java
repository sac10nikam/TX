...
public class PRR_PC5_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PRR_PC5_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PRR_PC5_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PRR_PC5_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
