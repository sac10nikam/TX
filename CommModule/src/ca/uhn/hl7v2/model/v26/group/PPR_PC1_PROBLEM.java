...
public class PPR_PC1_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PPR_PC1_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PPR_PC1_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PPR_PC1_PATHWAY> getPATHWAYAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PPR_PC1_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PPR_PC1_GOAL> getGOALAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PPR_PC1_ORDER> getORDERAll() throws HL7Exception {
