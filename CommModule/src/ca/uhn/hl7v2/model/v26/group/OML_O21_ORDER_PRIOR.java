...
public class OML_O21_ORDER_PRIOR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OML_O21_ORDER_PRIOR - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<OML_O21_TIMING_PRIOR> getTIMING_PRIORAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<OML_O21_OBSERVATION_PRIOR> getOBSERVATION_PRIORAll() throws HL7Exception {
