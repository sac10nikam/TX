...
public class PRR_PC5_ORDER_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PRR_PC5_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PRR_PC5_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
