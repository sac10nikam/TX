...
/**
 * <p>Represents a OPU_R25_ACCESSION_DETAIL group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                 * <li>1: NK1 (Next of Kin / Associated Parties) <b> repeating</b></li>
                 * <li>2: OPU_R25_PATIENT (a Group object) <b>optional </b></li>
                 * <li>3: OPU_R25_SPECIMEN (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class OPU_R25_ACCESSION_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OPU_R25_ACCESSION_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OPU_R25_PATIENT getPATIENT() { 
       OPU_R25_PATIENT retVal = getTyped("PATIENT", OPU_R25_PATIENT.class);
       return retVal;
    }
    ...
    public OPU_R25_SPECIMEN getSPECIMEN() { 
       OPU_R25_SPECIMEN retVal = getTyped("SPECIMEN", OPU_R25_SPECIMEN.class);
       return retVal;
    }
    ...
    public OPU_R25_SPECIMEN getSPECIMEN(int rep) { 
       OPU_R25_SPECIMEN retVal = getTyped("SPECIMEN", rep, OPU_R25_SPECIMEN.class);
       return retVal;
    }
    ...
    public List<OPU_R25_SPECIMEN> getSPECIMENAll() throws HL7Exception {
    	return getAllAsList("SPECIMEN", OPU_R25_SPECIMEN.class);
    } 
