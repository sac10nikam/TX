...
/**
 * <p>Represents a RDR_RDR_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                 * <li>1: ORC (Common Order) <b> </b></li>
                 * <li>2: RDR_RDR_ENCODING (a Group object) <b>optional </b></li>
                 * <li>3: RDR_RDR_DISPENSE (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class RDR_RDR_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RDR_RDR_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDR_RDR_ENCODING getENCODING() { 
       RDR_RDR_ENCODING retVal = getTyped("ENCODING", RDR_RDR_ENCODING.class);
       return retVal;
    }
    ...
    public RDR_RDR_DISPENSE getDISPENSE() { 
       RDR_RDR_DISPENSE retVal = getTyped("DISPENSE", RDR_RDR_DISPENSE.class);
       return retVal;
    }
    ...
    public RDR_RDR_DISPENSE getDISPENSE(int rep) { 
       RDR_RDR_DISPENSE retVal = getTyped("DISPENSE", rep, RDR_RDR_DISPENSE.class);
       return retVal;
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getDISPENSE()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public List<RDR_RDR_DISPENSE> getDISPENSEAll() throws HL7Exception {
    	return getAllAsList("DISPENSE", RDR_RDR_DISPENSE.class);
    } 

    /**
     * Inserts a specific repetition of DISPENSE (a Group object)
    ...
    /**
     * Removes a specific repetition of DISPENSE (a Group object)
