...
public class PTR_PCF_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PTR_PCF_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PTR_PCF_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PTR_PCF_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PTR_PCF_GOAL> getGOALAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PTR_PCF_ORDER> getORDERAll() throws HL7Exception {
