...
public class SRR_S01_SCHEDULE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating SRR_S01_SCHEDULE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<SRR_S01_PATIENT> getPATIENTAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<SRR_S01_RESOURCES> getRESOURCESAll() throws HL7Exception {
