...
public class ORN_O08_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating ORN_O08_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<ORN_O08_ORDER> getORDERAll() throws HL7Exception {
