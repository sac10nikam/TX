...
public class PPT_PCL_PATHWAY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PPT_PCL_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PPT_PCL_PATHWAY_ROLE> getPATHWAY_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PPT_PCL_GOAL> getGOALAll() throws HL7Exception {
