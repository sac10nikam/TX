...
/**
 * <p>Represents a EHC_E10_INVOICE_PROCESSING_RESULTS_INFO group structure (a Group object).
 ...
 * <ul>
                 ...
                 * <li>3: PYE (Payee Information) <b> </b></li>
                 * <li>4: IN1 (Insurance) <b> </b></li>
                 * <li>5: IN2 (Insurance Additional Information) <b>optional </b></li>
                 * <li>6: IVC (Invoice Segment) <b> </b></li>
                 * <li>7: EHC_E10_PRODUCT_SERVICE_SECTION (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class EHC_E10_INVOICE_PROCESSING_RESULTS_INFO extends AbstractGroup {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1856995526796912315L;
    ...
    private void init(ModelClassFactory factory) {
       try {
    	   ...
    	   Log.e(Constants.TAG, "Unexpected error creating EHC_E10_INVOICE_PROCESSING_RESULTS_INFO - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PYE getPYE() { 
       PYE retVal = getTyped("PYE", PYE.class);
       return retVal;
    }
    ...
    public EHC_E10_PRODUCT_SERVICE_SECTION getPRODUCT_SERVICE_SECTION() { 
       EHC_E10_PRODUCT_SERVICE_SECTION retVal = getTyped("PRODUCT_SERVICE_SECTION", EHC_E10_PRODUCT_SERVICE_SECTION.class);
       return retVal;
    }
    ...
    public EHC_E10_PRODUCT_SERVICE_SECTION getPRODUCT_SERVICE_SECTION(int rep) { 
       EHC_E10_PRODUCT_SERVICE_SECTION retVal = getTyped("PRODUCT_SERVICE_SECTION", rep, EHC_E10_PRODUCT_SERVICE_SECTION.class);
       return retVal;
    }
