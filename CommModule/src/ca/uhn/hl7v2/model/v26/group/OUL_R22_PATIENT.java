...
public class OUL_R22_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OUL_R22_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OUL_R22_VISIT getVISIT() { 
       OUL_R22_VISIT retVal = getTyped("VISIT", OUL_R22_VISIT.class);
       return retVal;
    }
