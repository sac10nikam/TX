...
/**
 * <p>Represents a RDR_RDR_DISPENSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                 * <li>1: RXE (Pharmacy/Treatment Encoded Order) <b> </b></li>
                 * <li>2: RXD (Pharmacy/Treatment Dispense) <b> </b></li>
                 * <li>3: RXR (Pharmacy/Treatment Route) <b> repeating</b></li>
                 * <li>4: TQ1 (Timing/Quantity) <b> </b></li>
                 * <li>5: RXC (Pharmacy/Treatment Component Order) <b>optional repeating</b></li>
                 * <li>6: TQ2 (Timing/Quantity Relationship) <b>optional repeating</b></li>
 * </ul>
 */
public class RDR_RDR_DISPENSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RDR_RDR_DISPENSE - this is probably a bug in the source code generator.", e);
       }
    }
