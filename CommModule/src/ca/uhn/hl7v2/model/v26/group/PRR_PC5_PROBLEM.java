...
public class PRR_PC5_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PRR_PC5_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PRR_PC5_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PRR_PC5_PROBLEM_PATHWAY> getPROBLEM_PATHWAYAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PRR_PC5_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PRR_PC5_GOAL> getGOALAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PRR_PC5_ORDER> getORDERAll() throws HL7Exception {
