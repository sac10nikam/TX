...
public class RGV_O15_GIVE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RGV_O15_GIVE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RGV_O15_TIMING_GIVE> getTIMING_GIVEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<RGV_O15_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
