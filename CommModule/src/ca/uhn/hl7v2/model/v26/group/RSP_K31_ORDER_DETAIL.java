...
public class RSP_K31_ORDER_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RSP_K31_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RSP_K31_COMPONENTS> getCOMPONENTSAll() throws HL7Exception {
