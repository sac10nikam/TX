...
public class BAR_P05_VISIT extends AbstractGroup {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4815497891981048337L;
    ...
    private void init(ModelClassFactory factory) {
       try {
    	   ...
    	   Log.e(Constants.TAG, "Unexpected error creating BAR_P05_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<BAR_P05_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<BAR_P05_INSURANCE> getINSURANCEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<BLC> getBLCAll() throws HL7Exception {
