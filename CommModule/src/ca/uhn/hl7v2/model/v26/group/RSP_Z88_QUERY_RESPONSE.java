...
public class RSP_Z88_QUERY_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RSP_Z88_QUERY_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RSP_Z88_COMMON_ORDER> getCOMMON_ORDERAll() throws HL7Exception {
