...
public class ORS_O06_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating ORS_O06_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<ORS_O06_ORDER> getORDERAll() throws HL7Exception {
