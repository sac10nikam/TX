...
public class DFT_P03_COMMON_ORDER extends AbstractGroup {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1651350565707325601L;
    ...
    private void init(ModelClassFactory factory) {
       try {
    	   ...
    	   Log.e(Constants.TAG, "Unexpected error creating DFT_P03_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<DFT_P03_TIMING_QUANTITY> getTIMING_QUANTITYAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<DFT_P03_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
