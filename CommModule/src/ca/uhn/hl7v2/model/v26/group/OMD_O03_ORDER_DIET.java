...
public class OMD_O03_ORDER_DIET extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OMD_O03_ORDER_DIET - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<OMD_O03_TIMING_DIET> getTIMING_DIETAll() throws HL7Exception {
