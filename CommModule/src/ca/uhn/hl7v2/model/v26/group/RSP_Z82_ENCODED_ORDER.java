...
public class RSP_Z82_ENCODED_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RSP_Z82_ENCODED_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RSP_Z82_TIMING_ENCODED> getTIMING_ENCODEDAll() throws HL7Exception {
