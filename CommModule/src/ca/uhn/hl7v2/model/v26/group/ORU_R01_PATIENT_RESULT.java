...
public class ORU_R01_PATIENT_RESULT extends AbstractGroup {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7158559191638074207L;
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating ORU_R01_PATIENT_RESULT - this is probably a bug in the source code generator.");
       }
    }
     ...
     * </p>
     */ 
    public List<ORU_R01_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
