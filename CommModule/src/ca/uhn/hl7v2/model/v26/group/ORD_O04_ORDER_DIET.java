...
public class ORD_O04_ORDER_DIET extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating ORD_O04_ORDER_DIET - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<ORD_O04_TIMING_DIET> getTIMING_DIETAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<ODS> getODSAll() throws HL7Exception {
