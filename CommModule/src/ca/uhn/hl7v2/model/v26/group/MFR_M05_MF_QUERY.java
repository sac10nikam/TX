 ...
 * <ul>
                 ...
                 * <li>5: MFR_M05_MF_LOC_DEPT (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class MFR_M05_MF_QUERY extends AbstractGroup {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5065229142313338809L;
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating MFR_M05_MF_QUERY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public MFR_M05_MF_LOC_DEPT getMF_LOC_DEPT() { 
       MFR_M05_MF_LOC_DEPT retVal = getTyped("MF_LOC_DEPT", MFR_M05_MF_LOC_DEPT.class);
       return retVal;
    }
    ...
    public MFR_M05_MF_LOC_DEPT getMF_LOC_DEPT(int rep) { 
       MFR_M05_MF_LOC_DEPT retVal = getTyped("MF_LOC_DEPT", rep, MFR_M05_MF_LOC_DEPT.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public List<MFR_M05_MF_LOC_DEPT> getMF_LOC_DEPTAll() throws HL7Exception {
    	return getAllAsList("MF_LOC_DEPT", MFR_M05_MF_LOC_DEPT.class);
    } 
