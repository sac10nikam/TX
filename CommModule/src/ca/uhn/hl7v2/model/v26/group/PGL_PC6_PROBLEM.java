...
public class PGL_PC6_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating PGL_PC6_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<PGL_PC6_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
     ...
     * </p>
     */ 
    public List<PGL_PC6_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
