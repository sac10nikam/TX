 ...
 * <ul>
                 ...
                 * <li>6: RGR_RGR_DEFINITION (a Group object) <b> repeating</b></li>
...
public class RGR_RGR extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RGR_RGR - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RGR_RGR_DEFINITION> getDEFINITIONAll() throws HL7Exception {
