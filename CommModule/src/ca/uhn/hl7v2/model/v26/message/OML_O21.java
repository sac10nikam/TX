...
public class OML_O21 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OML_O21 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<OML_O21_ORDER> getORDERAll() throws HL7Exception {
