 ...
 * <ul>
                 ...
                 * <li>4: SCP (Sterilizer Configuration Segment) <b> repeating</b></li>
 * </ul>
 */
public class STC_S33 extends AbstractMessage  {
    ...
    /**
     * Creates a new STC_S33 message with DefaultModelClassFactory. 
     */ 
    public STC_S33() { 
    ...
    /** 
     * Creates a new STC_S33 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating STC_S33 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SCP getSCP(int rep) { 
       return getTyped("SCP", rep, SCP.class);
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getSCP()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public List<SCP> getSCPAll() throws HL7Exception {
    	return getAllAsList("SCP", SCP.class);
    } 
    ...
    public void insertSCP(SCP structure, int rep) throws HL7Exception { 
       super.insertRepetition( "SCP", structure, rep);
    }
