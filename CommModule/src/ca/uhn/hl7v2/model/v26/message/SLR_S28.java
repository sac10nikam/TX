 ...
 * <ul>
                 ...
                 * <li>4: SLT (Sterilization Lot) <b> repeating</b></li>
 * </ul>
 */
public class SLR_S28 extends AbstractMessage  {
    ...
    /**
     * Creates a new SLR_S28 message with DefaultModelClassFactory. 
     */ 
    public SLR_S28() { 
    ...
    /** 
     * Creates a new SLR_S28 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating SLR_S28 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * SLT (Sterilization Lot) - creates it if necessary
     */
    public SLT getSLT() { 
       return getTyped("SLT", SLT.class);
    }
    ...
    public SLT getSLT(int rep) { 
       return getTyped("SLT", rep, SLT.class);
    }
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of SLT.
     * <p>
     * <p>
     * Note that unlike {@link #getSLT()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public List<SLT> getSLTAll() throws HL7Exception {
    	return getAllAsList("SLT", SLT.class);
    } 

    /**
     * Inserts a specific repetition of SLT (Sterilization Lot)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    ...
    /**
     * Removes a specific repetition of SLT (Sterilization Lot)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
