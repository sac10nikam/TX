 ...
 * <ul>
                 ...
                 * <li>8: EHC_E02_PRODUCT_SERVICE_SECTION (a Group object) <b>optional repeating</b></li>
 * </ul>
 */
public class EHC_E02 extends AbstractMessage  {
    ...
    /**
     * Creates a new EHC_E02 message with DefaultModelClassFactory. 
     */ 
    public EHC_E02() { 
    ...
    /** 
     * Creates a new EHC_E02 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating EHC_E02 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public EHC_E02_PRODUCT_SERVICE_SECTION getPRODUCT_SERVICE_SECTION() { 
       return getTyped("PRODUCT_SERVICE_SECTION", EHC_E02_PRODUCT_SERVICE_SECTION.class);
    }
    ...
    public EHC_E02_PRODUCT_SERVICE_SECTION getPRODUCT_SERVICE_SECTION(int rep) { 
       return getTyped("PRODUCT_SERVICE_SECTION", rep, EHC_E02_PRODUCT_SERVICE_SECTION.class);
    }
     ...
     * </p>
     */ 
    public List<EHC_E02_PRODUCT_SERVICE_SECTION> getPRODUCT_SERVICE_SECTIONAll() throws HL7Exception {
    	return getAllAsList("PRODUCT_SERVICE_SECTION", EHC_E02_PRODUCT_SERVICE_SECTION.class);
    } 
