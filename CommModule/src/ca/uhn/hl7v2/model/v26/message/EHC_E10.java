 ...
 * <ul>
                 ...
                 * <li>6: EHC_E10_INVOICE_PROCESSING_RESULTS_INFO (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class EHC_E10 extends AbstractMessage  {
    ...
    /**
     * Creates a new EHC_E10 message with DefaultModelClassFactory. 
     */ 
    public EHC_E10() { 
    ...
    /** 
     * Creates a new EHC_E10 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating EHC_E10 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public EHC_E10_INVOICE_PROCESSING_RESULTS_INFO getINVOICE_PROCESSING_RESULTS_INFO() { 
       return getTyped("INVOICE_PROCESSING_RESULTS_INFO", EHC_E10_INVOICE_PROCESSING_RESULTS_INFO.class);
    }
    ...
    public EHC_E10_INVOICE_PROCESSING_RESULTS_INFO getINVOICE_PROCESSING_RESULTS_INFO(int rep) { 
       return getTyped("INVOICE_PROCESSING_RESULTS_INFO", rep, EHC_E10_INVOICE_PROCESSING_RESULTS_INFO.class);
    }
    ...
    public List<EHC_E10_INVOICE_PROCESSING_RESULTS_INFO> getINVOICE_PROCESSING_RESULTS_INFOAll() throws HL7Exception {
    	return getAllAsList("INVOICE_PROCESSING_RESULTS_INFO", EHC_E10_INVOICE_PROCESSING_RESULTS_INFO.class);
    } 
