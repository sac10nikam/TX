 ...
 * <ul>
                 ...
                 * <li>7: OPR_O38_RESPONSE (a Group object) <b>optional repeating</b></li>
 * </ul>
 */
public class OPR_O38 extends AbstractMessage  {
    ...
    /**
     * Creates a new OPR_O38 message with DefaultModelClassFactory. 
     */ 
    public OPR_O38() { 
    ...
    /** 
     * Creates a new OPR_O38 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OPR_O38 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OPR_O38_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", OPR_O38_RESPONSE.class);
    }
    ...
    public OPR_O38_RESPONSE getRESPONSE(int rep) { 
       return getTyped("RESPONSE", rep, OPR_O38_RESPONSE.class);
    }
     ...
     * </p>
     */ 
    public List<OPR_O38_RESPONSE> getRESPONSEAll() throws HL7Exception {
    	return getAllAsList("RESPONSE", OPR_O38_RESPONSE.class);
    } 
