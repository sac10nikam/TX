 ...
 * <ul>
                 ...
                 * <li>5: MFN_M16_MATERIAL_ITEM_RECORD (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class MFN_M16 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFN_M16 message with DefaultModelClassFactory. 
     */ 
    public MFN_M16() { 
    ...
    /** 
     * Creates a new MFN_M16 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating MFN_M16 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * MATERIAL_ITEM_RECORD (a Group object) - creates it if necessary
     */
    ...
    public MFN_M16_MATERIAL_ITEM_RECORD getMATERIAL_ITEM_RECORD(int rep) { 
       return getTyped("MATERIAL_ITEM_RECORD", rep, MFN_M16_MATERIAL_ITEM_RECORD.class);
    }

    /** 
     * Returns the number of existing repetitions of MATERIAL_ITEM_RECORD 
     */ 
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MATERIAL_ITEM_RECORD.
     * <p>
     * <p>
     * Note that unlike {@link #getMATERIAL_ITEM_RECORD()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    ...
    /**
     * Inserts a specific repetition of MATERIAL_ITEM_RECORD (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMATERIAL_ITEM_RECORD(MFN_M16_MATERIAL_ITEM_RECORD structure, int rep) throws HL7Exception { 
       super.insertRepetition( "MATERIAL_ITEM_RECORD", structure, rep);
    }
    ...
    /**
     * Removes a specific repetition of MATERIAL_ITEM_RECORD (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
