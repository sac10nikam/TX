...
public class CRM_C01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating CRM_C01 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<CRM_C01_PATIENT> getPATIENTAll() throws HL7Exception {
