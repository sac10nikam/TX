 ...
 * <ul>
                 ...
                 * <li>5: ROL (Role) <b> repeating</b></li>
                 * <li>6: OPL_O37_GUARANTOR (a Group object) <b>optional </b></li>
                 * <li>7: OPL_O37_ORDER (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class OPL_O37 extends AbstractMessage  {
    ...
    /**
     * Creates a new OPL_O37 message with DefaultModelClassFactory. 
     */ 
    public OPL_O37() { 
    ...
    /** 
     * Creates a new OPL_O37 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OPL_O37 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * GUARANTOR (a Group object) - creates it if necessary
     */
    public OPL_O37_GUARANTOR getGUARANTOR() { 
       return getTyped("GUARANTOR", OPL_O37_GUARANTOR.class);
    }
    ...
    public OPL_O37_ORDER getORDER() { 
       return getTyped("ORDER", OPL_O37_ORDER.class);
    }
    ...
    public OPL_O37_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, OPL_O37_ORDER.class);
    }
    ...
    public List<OPL_O37_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", OPL_O37_ORDER.class);
    } 
