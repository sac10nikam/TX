 ...
 * <ul>
                 ...
                 * <li>8: RSP_E03_INVOICE_PROCESSING_RESULTS_INFO (a Group object) <b>optional repeating</b></li>
 * </ul>
 */
public class RSP_E03 extends AbstractMessage  {
    ...
    /**
     * Creates a new RSP_E03 message with DefaultModelClassFactory. 
     */ 
    public RSP_E03() { 
    ...
    /** 
     * Creates a new RSP_E03 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RSP_E03 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * INVOICE_PROCESSING_RESULTS_INFO (a Group object) - creates it if necessary
     */
    public RSP_E03_INVOICE_PROCESSING_RESULTS_INFO getINVOICE_PROCESSING_RESULTS_INFO() { 
       return getTyped("INVOICE_PROCESSING_RESULTS_INFO", RSP_E03_INVOICE_PROCESSING_RESULTS_INFO.class);
    }
    ...
    public RSP_E03_INVOICE_PROCESSING_RESULTS_INFO getINVOICE_PROCESSING_RESULTS_INFO(int rep) { 
       return getTyped("INVOICE_PROCESSING_RESULTS_INFO", rep, RSP_E03_INVOICE_PROCESSING_RESULTS_INFO.class);
    }

    /** 
     * Returns the number of existing repetitions of INVOICE_PROCESSING_RESULTS_INFO 
     */ 
    public int getINVOICE_PROCESSING_RESULTS_INFOReps() { 
    	return getReps("INVOICE_PROCESSING_RESULTS_INFO");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of INVOICE_PROCESSING_RESULTS_INFO.
     * <p>
     * <p>
     * Note that unlike {@link #getINVOICE_PROCESSING_RESULTS_INFO()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public List<RSP_E03_INVOICE_PROCESSING_RESULTS_INFO> getINVOICE_PROCESSING_RESULTS_INFOAll() throws HL7Exception {
    	return getAllAsList("INVOICE_PROCESSING_RESULTS_INFO", RSP_E03_INVOICE_PROCESSING_RESULTS_INFO.class);
    } 

    /**
     * Inserts a specific repetition of INVOICE_PROCESSING_RESULTS_INFO (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    ...
    /**
     * Removes a specific repetition of INVOICE_PROCESSING_RESULTS_INFO (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
