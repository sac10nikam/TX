 ...
 * <ul>
                 ...
                 * <li>4: RFI (Request for Information) <b> </b></li>
                 * <li>5: CTD (Contact Data) <b>optional repeating</b></li>
                 * <li>6: IVC (Invoice Segment) <b> </b></li>
                 * <li>7: PSS (Product/Service Section) <b> </b></li>
                 * <li>8: PSG (Product/Service Group) <b> </b></li>
                 * <li>9: PID (Patient Identification) <b>optional </b></li>
                 * <li>10: PSL (Product/Service Line Item) <b>optional repeating</b></li>
                 * <li>11: EHC_E12_REQUEST (a Group object) <b> repeating</b></li>
 * </ul>
 */
public class EHC_E12 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating EHC_E12 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PSL getPSL(int rep) { 
       return getTyped("PSL", rep, PSL.class);
    }
    ...
    public EHC_E12_REQUEST getREQUEST() { 
       return getTyped("REQUEST", EHC_E12_REQUEST.class);
    }
    ...
    public EHC_E12_REQUEST getREQUEST(int rep) { 
       return getTyped("REQUEST", rep, EHC_E12_REQUEST.class);
    }
    ...
    public List<EHC_E12_REQUEST> getREQUESTAll() throws HL7Exception {
    	return getAllAsList("REQUEST", EHC_E12_REQUEST.class);
    } 
