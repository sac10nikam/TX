...
public class OML_O35 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating OML_O35 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<OML_O35_SPECIMEN> getSPECIMENAll() throws HL7Exception {
