...
public class RSP_Z88 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          Log.e(Constants.TAG, "Unexpected error creating RSP_Z88 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public List<RSP_Z88_QUERY_RESPONSE> getQUERY_RESPONSEAll() throws HL7Exception {
