...
public class PKG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 2, new Object[]{ getMessage() }, "Set Id - PKG");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Packaging Units");
                                  this.add(CNE.class, false, 1, 1, new Object[]{ getMessage() }, "Default Order Unit Of Measure Indicator");
                                  this.add(NM.class, false, 1, 12, new Object[]{ getMessage() }, "Package Quantity");
                                  this.add(CP.class, false, 1, 12, new Object[]{ getMessage() }, "Price");
                                  this.add(CP.class, false, 1, 12, new Object[]{ getMessage() }, "Future Item Price");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Future Item Price Effective Date");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PKG - this is probably a bug in the source code generator.", e);
       }
    }
