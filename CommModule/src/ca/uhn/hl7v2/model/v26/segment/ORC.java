...
public class ORC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date/Time of Transaction");
                                  this.add(XCN.class, false, 0, 3220, new Object[]{ getMessage() }, "Entered By");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Order Effective Date/Time");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Order Control Code Reason");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Entering Organization");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Entering Device");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Filler's Expected Availability Date/Time");
    	   ...
    	   Log.e(Constants.TAG, "Unexpected error creating ORC - this is probably a bug in the source code generator.", e);
       }
    }
