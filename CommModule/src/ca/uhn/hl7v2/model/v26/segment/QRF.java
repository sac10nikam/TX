 ...
 * <ul>
     ...
     * <li>QRF-2: When Data Start Date/Time (DTM) <b>optional </b>
     * <li>QRF-3: When Data End Date/Time (DTM) <b>optional </b>
...
public class QRF extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "When Data Start Date/Time");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "When Data End Date/Time");
                                  ...
                                  this.add(TQ.class, false, 1, 0, new Object[]{ getMessage() }, "When Quantity/Timing Qualifier");
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Search Confidence Threshold");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating QRF - this is probably a bug in the source code generator.", e);
       }
    }
