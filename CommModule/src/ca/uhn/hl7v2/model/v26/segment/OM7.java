...
public class OM7 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Category Identifier");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Effective Test/Service Start Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Effective Test/Service End Date/Time");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Test/Service Default Duration Quantity");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Test/Service Default Duration Units");
                                              this.add(IS.class, false, 1, 60, new Object[]{ getMessage(), new Integer(0) }, "Test/Service Default Frequency");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Consent Indicator");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Consent Identifier");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Consent Effective Start Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Consent Effective End Date/Time");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Consent Interval Quantity");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Consent Interval Units");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Consent Waiting Period Quantity");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Consent Waiting Period Units");
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Primary Key Value - CDM");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating OM7 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 9: return new IS(getMessage(), new Integer( 0 ));
