...
public class SID extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Application/Method Identifier");
                                  ...
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Substance Manufacturer Identifier");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating SID - this is probably a bug in the source code generator.", e);
       }
    }
