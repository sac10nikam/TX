...
public class AIG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Set ID - AIG");
                                              this.add(ID.class, false, 1, 3, new Object[]{ getMessage(), 206 }, "Segment Action Code");
                                  ...
                                  this.add(CNE.class, false, 1, 250, new Object[]{ getMessage() }, "Duration Units");
                                              this.add(IS.class, false, 1, 10, new Object[]{ getMessage(), 279 }, "Allow Substitution Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Filler Status Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating AIG - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 1: return new ID(getMessage(), 206);
          ...
          case 12: return new IS(getMessage(), 279);
