 ...
 * <ul>
     ...
     * <li>CER-14: Subject Directory Attribute Extension (CWE) <b>optional repeating</b>
     ...
     * <li>CER-23: Granting Date (DTM) <b>optional </b>
     * <li>CER-24: Issuing Date (DTM) <b>optional </b>
     * <li>CER-25: Activation Date (DTM) <b>optional </b>
     * <li>CER-26: Inactivation Date (DTM) <b>optional </b>
     * <li>CER-27: Expiration Date (DTM) <b>optional </b>
     * <li>CER-28: Renewal Date (DTM) <b>optional </b>
     * <li>CER-29: Revocation Date (DTM) <b>optional </b>
     * <li>CER-30: Revocation Reason Code (CWE) <b>optional </b>
     * <li>CER-31: Certificate Status Code (CWE) <b>optional </b>
 * </ul>
 */
public class CER extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Subject Directory Attribute Extension");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Granting Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Issuing Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Activation Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Inactivation Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Expiration Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Renewal Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Revocation Date");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Revocation Reason Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Certificate Status Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating CER - this is probably a bug in the source code generator.", e);
       }
    }
