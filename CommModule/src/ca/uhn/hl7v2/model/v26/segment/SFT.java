...
public class SFT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Software Install Date");
       } catch(HL7Exception e) {
    	   Log.e(Constants.TAG, "Unexpected error creating SFT - this is probably a bug in the source code generator.", e);
       }
    }
