...
public class REL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Relationship Type");
                                  this.add(EI.class, true, 1, 60, new Object[]{ getMessage() }, "This Relationship Instance Identifier");
                                  this.add(EI.class, true, 1, 60, new Object[]{ getMessage() }, "Source Information Instance Identifier");
                                  this.add(EI.class, true, 1, 60, new Object[]{ getMessage() }, "Target Information Instance Identifier");
                                  this.add(EI.class, false, 1, 60, new Object[]{ getMessage() }, "Asserting Entity Instance ID");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "Asserting Person");
                                  this.add(XON.class, false, 1, 250, new Object[]{ getMessage() }, "Asserting Organization");
                                  this.add(XAD.class, false, 1, 250, new Object[]{ getMessage() }, "Assertor Address");
                                  this.add(XTN.class, false, 1, 250, new Object[]{ getMessage() }, "Assertor Contact");
                                  this.add(DR.class, false, 1, 53, new Object[]{ getMessage() }, "Assertion Date Range");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Negation Indicator");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Certainty of Relationship");
                                  this.add(NM.class, false, 1, 26, new Object[]{ getMessage() }, "Priority No");
                                  this.add(NM.class, false, 1, 250, new Object[]{ getMessage() }, "Priority  Sequence No (rel preference for consideration)");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Separability Indicator");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating REL - this is probably a bug in the source code generator.", e);
       }
    }
