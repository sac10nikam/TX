...
public class CDM extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Primary Key Value - CDM");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Charge Code Alias");
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Exploding Charges");
                                  this.add(CNE.class, false, 0, 705, new Object[]{ getMessage() }, "Procedure Code");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(183) }, "Active/Inactive Flag");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Inventory Number");
          ...
          Log.e(Constants.TAG, "Unexpected error creating CDM - this is probably a bug in the source code generator.", e);
       }
    }
