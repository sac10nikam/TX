...
public class EQP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Event type");
                                  this.add(ST.class, false, 1, 20, new Object[]{ getMessage() }, "File Name");
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Start Date/Time");
          ...
          Log.e(Constants.TAG, "Unexpected error creating EQP - this is probably a bug in the source code generator.", e);
       }
    }
