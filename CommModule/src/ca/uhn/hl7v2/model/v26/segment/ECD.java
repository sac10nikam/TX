...
public class ECD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Remote Control Command");
                                              this.add(ID.class, false, 1, 80, new Object[]{ getMessage(), new Integer(136) }, "Response Required");
                                  this.add(TQ.class, false, 1, 0, new Object[]{ getMessage() }, "Requested Completion Time");
                                  this.add(TX.class, false, 0, 65536, new Object[]{ getMessage() }, "Parameters");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating ECD - this is probably a bug in the source code generator.", e);
       }
    }
