 ...
 * <ul>
     ...
     * <li>RQ1-2: Manufacturer Identifier (CWE) <b>optional </b>
     * <li>RQ1-3: Manufacturer's Catalog (ST) <b>optional </b>
     * <li>RQ1-4: Vendor ID (CWE) <b>optional </b>
...
public class RQ1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Vendor ID");
          ...
          Log.e(Constants.TAG, "Unexpected error creating RQ1 - this is probably a bug in the source code generator.", e);
       }
    }
