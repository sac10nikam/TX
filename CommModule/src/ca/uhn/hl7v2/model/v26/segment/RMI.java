...
public class RMI extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Risk Management Incident Code");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date/Time Incident");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Incident Type Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating RMI - this is probably a bug in the source code generator.", e);
       }
    }
