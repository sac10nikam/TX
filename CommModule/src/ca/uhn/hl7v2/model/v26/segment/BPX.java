...
public class BPX extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "BP Expiration Date/Time");
          ...
          Log.e(Constants.TAG, "Unexpected error creating BPX - this is probably a bug in the source code generator.", e);
       }
    }
