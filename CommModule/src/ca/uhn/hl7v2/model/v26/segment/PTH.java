...
public class PTH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Pathway ID");
                                  this.add(EI.class, true, 1, 60, new Object[]{ getMessage() }, "Pathway Instance ID");
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Pathway Established Date/Time");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Pathway Life Cycle Status");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Change Pathway Life Cycle Status Date/Time");
                                  this.add(CNE.class, false, 1, 60, new Object[]{ getMessage() }, "Mood Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PTH - this is probably a bug in the source code generator.", e);
       }
    }
