 ...
 * <ul>
     * <li>URD-1: R/U Date/Time (DTM) <b>optional </b>
     * <li>URD-2: Report Priority (ID) <b>optional </b>
     * <li>URD-3: R/U Who Subject Definition (XCN) <b> repeating</b>
     * <li>URD-4: R/U What Subject Definition (CWE) <b>optional repeating</b>
     * <li>URD-5: R/U What Department Code (CWE) <b>optional repeating</b>
...
public class URD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "R/U Date/Time");
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "R/U What Subject Definition");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "R/U What Department Code");
          ...
          Log.e(Constants.TAG, "Unexpected error creating URD - this is probably a bug in the source code generator.", e);
       }
    }
