...
public class PCE extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 2, new Object[]{ getMessage() }, "Set ID - PCE");
          ...
          Log.e(Constants.TAG, "Unexpected error creating PCE - this is probably a bug in the source code generator.", e);
       }
    }
