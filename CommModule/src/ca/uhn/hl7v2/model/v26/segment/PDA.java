...
public class PDA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 0, 705, new Object[]{ getMessage() }, "Death Cause Code");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Death Certificate Signed Date/Time");
          ...
          Log.e(Constants.TAG, "Unexpected error creating PDA - this is probably a bug in the source code generator.", e);
       }
    }
