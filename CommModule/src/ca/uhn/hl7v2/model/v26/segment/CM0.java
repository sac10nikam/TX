...
public class CM0 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EI.class, false, 3, 427, new Object[]{ getMessage() }, "Alternate Study ID");
          ...
          Log.e(Constants.TAG, "Unexpected error creating CM0 - this is probably a bug in the source code generator.", e);
       }
    }
