 ...
 * <ul>
     * <li>PRA-1: Primary Key Value - PRA (CWE) <b>optional </b>
     * <li>PRA-2: Practitioner Group (CWE) <b>optional repeating</b>
     ...
     * <li>PRA-9: Institution (CWE) <b>optional </b>
     * <li>PRA-10: Date Left Practice (DT) <b>optional </b>
     * <li>PRA-11: Government Reimbursement Billing Eligibility (CWE) <b>optional repeating</b>
...
public class PRA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Primary Key Value - PRA");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Practitioner Group");
                                  ...
                                  this.add(PLN.class, false, 0, 0, new Object[]{ getMessage() }, "Practitioner ID Numbers");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Institution");
                                  this.add(DT.class, false, 1, 8, new Object[]{ getMessage() }, "Date Left Practice");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Government Reimbursement Billing Eligibility");
                                  this.add(SI.class, false, 1, 60, new Object[]{ getMessage() }, "Set ID - PRA");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PRA - this is probably a bug in the source code generator.", e);
       }
    }
