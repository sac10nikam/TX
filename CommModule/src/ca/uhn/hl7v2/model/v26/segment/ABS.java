...
public class ABS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Transfer Medical Service Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Severity of Illness Code");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date/Time of Attestation");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "Attested By");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Triage Code");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Abstract Completion Date/Time");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "Abstracted By");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Case Category Code");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), 136 }, "Caesarian Section Indicator");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Gestation Category Code");
                                  this.add(NM.class, false, 1, 3, new Object[]{ getMessage() }, "Gestation Period - Weeks");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Newborn Code");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), 136 }, "Stillborn Indicator");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating ABS - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 13: return new ID(getMessage(), 136);
          default: return null;
       }
   }
