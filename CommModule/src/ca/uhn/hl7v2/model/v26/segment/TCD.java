 ...
 * <ul>
     * <li>TCD-1: Universal Service Identifier (CWE) <b> </b>
     ...
     * <li>TCD-8: Analyte Repeat Status (CWE) <b>optional </b>
 * </ul>
 */
public class TCD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(SN.class, false, 1, 36, new Object[]{ getMessage() }, "Auto-Dilution Factor");
                                  this.add(SN.class, false, 1, 36, new Object[]{ getMessage() }, "Rerun Dilution Factor");
                                  this.add(SN.class, false, 1, 36, new Object[]{ getMessage() }, "Pre-Dilution Factor");
                                  ...
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Analyte Repeat Status");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating TCD - this is probably a bug in the source code generator.", e);
       }
    }
