 ...
 * <ul>
     ...
     * <li>LOC-7: License Number (CWE) <b>optional repeating</b>
...
public class LOC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "License Number");
          ...
          Log.e(Constants.TAG, "Unexpected error creating LOC - this is probably a bug in the source code generator.", e);
       }
    }
