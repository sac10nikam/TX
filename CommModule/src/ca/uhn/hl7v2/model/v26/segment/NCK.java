 ...
 * <ul>
     * <li>NCK-1: System Date/Time (DTM) <b> </b>
 * </ul>
 */
public class NCK extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "System Date/Time");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating NCK - this is probably a bug in the source code generator.", e);
       }
    }
