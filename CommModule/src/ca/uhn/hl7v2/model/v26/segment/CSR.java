...
public class CSR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 427, new Object[]{ getMessage() }, "Sponsor Study ID");
                                  this.add(EI.class, false, 1, 427, new Object[]{ getMessage() }, "Alternate Study ID");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Institution Registering the Patient");
                                  this.add(CX.class, true, 1, 1913, new Object[]{ getMessage() }, "Sponsor Patient ID");
                                  this.add(CX.class, false, 1, 1913, new Object[]{ getMessage() }, "Alternate Patient ID - CSR");
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Date/Time of Patient Study Registration");
                                  this.add(XCN.class, false, 0, 3220, new Object[]{ getMessage() }, "Person Performing Study Registration");
                                  this.add(XCN.class, true, 0, 3220, new Object[]{ getMessage() }, "Study Authorizing Provider");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date/time Patient Study Consent Signed");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Patient Study Eligibility Status");
                                  this.add(DTM.class, false, 3, 24, new Object[]{ getMessage() }, "Study Randomization Date/time");
                                  this.add(CWE.class, false, 3, 705, new Object[]{ getMessage() }, "Randomized Study Arm");
                                  this.add(CWE.class, false, 3, 705, new Object[]{ getMessage() }, "Stratum for Study Randomization");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Patient Evaluability Status");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date/time Ended Study");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Reason Ended Study");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating CSR - this is probably a bug in the source code generator.", e);
       }
    }
