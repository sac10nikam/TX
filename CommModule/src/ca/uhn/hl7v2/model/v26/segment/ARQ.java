...
public class ARQ extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Request Event Reason");
                                  ...
                                  this.add(DR.class, false, 0, 49, new Object[]{ getMessage() }, "Requested Start Date/Time Range");
          ...
          Log.e(Constants.TAG, "Unexpected error creating ARQ - this is probably a bug in the source code generator.", e);
       }
    }
