...
/**
 *<p>Represents an HL7 SCP message segment (Sterilizer Configuration Segment). 
...
public class SCP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(NM.class, false, 1, 2, new Object[]{ getMessage() }, "Number Of Decontamination/Sterilization Devices");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Labor Calculation Type");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Date Format");
                                  this.add(EI.class, false, 1, 8, new Object[]{ getMessage() }, "Device Number");
                                  this.add(ST.class, false, 1, 999, new Object[]{ getMessage() }, "Device Name");
                                  this.add(ST.class, false, 1, 2, new Object[]{ getMessage() }, "Device Model Name");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Device Type");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Lot Control");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating SCP - this is probably a bug in the source code generator.", e);
       }
    }
