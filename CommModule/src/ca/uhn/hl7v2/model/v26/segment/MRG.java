...
public class MRG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CX.class, false, 0, 0, new Object[]{ getMessage() }, "Prior Alternate Patient ID");
                                  this.add(CX.class, false, 1, 250, new Object[]{ getMessage() }, "Prior Patient Account Number");
                                  this.add(CX.class, false, 1, 0, new Object[]{ getMessage() }, "Prior Patient ID");
          ...
          Log.e(Constants.TAG, "Unexpected error creating MRG - this is probably a bug in the source code generator.", e);
       }
    }
