...
public class BTX extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "BP Date/Time of Status");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "BP Transfusion Administrator");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "BP Transfusion Verifier");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "BP Transfusion Start Date/Time of Status");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "BP Transfusion End Date/Time of Status");
          ...
          Log.e(Constants.TAG, "Unexpected error creating BTX - this is probably a bug in the source code generator.", e);
       }
    }
