...
public class CNS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Starting Notification Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Ending Notification Date/Time");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Starting Notification Code");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Ending Notification Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating CNS - this is probably a bug in the source code generator.", e);
       }
    }
