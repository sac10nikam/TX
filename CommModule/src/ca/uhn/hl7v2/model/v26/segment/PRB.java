...
public class PRB extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Action Date/Time");
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Problem ID");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Problem Established Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Anticipated Problem Resolution Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Actual Problem Resolution Date/Time");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Classification");
                                  this.add(CWE.class, false, 0, 705, new Object[]{ getMessage() }, "Problem Management Discipline");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Persistence");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Confirmation Status");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Life Cycle Status");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Problem Life Cycle Status Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Problem Date of Onset");
                                  this.add(ST.class, false, 1, 80, new Object[]{ getMessage() }, "Problem Onset Text");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Ranking");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Certainty of Problem");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Probability of Problem (0-1)");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Individual Awareness of Problem");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Prognosis");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Individual Awareness of Prognosis");
                                  this.add(ST.class, false, 1, 200, new Object[]{ getMessage() }, "Family/Significant Other Awareness of Problem/Prognosis");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Security/Sensitivity");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Severity");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Problem Perspective");
                                  this.add(CNE.class, false, 1, 60, new Object[]{ getMessage() }, "Mood Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PRB - this is probably a bug in the source code generator.", e);
       }
    }
