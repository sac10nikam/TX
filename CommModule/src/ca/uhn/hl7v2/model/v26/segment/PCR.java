...
public class PCR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Implicated Product");
                                              this.add(IS.class, false, 1, 1, new Object[]{ getMessage(), new Integer(249) }, "Generic Product");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Product Class");
                                  this.add(CQ.class, false, 1, 500, new Object[]{ getMessage() }, "Total Duration Of Therapy");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Product Manufacture Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Product Expiration Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Product Implantation Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Product Explantation Date");
                                              this.add(IS.class, false, 1, 8, new Object[]{ getMessage(), new Integer(244) }, "Single Use Device");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Indication For Product Use");
                                              this.add(IS.class, false, 1, 8, new Object[]{ getMessage(), new Integer(245) }, "Product Problem");
                                  this.add(ST.class, false, 3, 199, new Object[]{ getMessage() }, "Product Serial/Lot Number");
                                              this.add(IS.class, false, 1, 1, new Object[]{ getMessage(), new Integer(246) }, "Product Available For Inspection");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Product Evaluation Performed");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Product Evaluation Status");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Product Evaluation Results");
                                              this.add(ID.class, false, 1, 8, new Object[]{ getMessage(), new Integer(248) }, "Evaluated Product Source");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date Product Returned To Manufacturer");
          ...
          Log.e(Constants.TAG, "Unexpected error creating PCR - this is probably a bug in the source code generator.", e);
       }
    }
