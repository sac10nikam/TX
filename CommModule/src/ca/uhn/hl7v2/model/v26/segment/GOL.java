...
public class GOL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Goal ID");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Goal Established Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Expected Goal Achieve Date/Time");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Goal Classification");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Goal Management Discipline");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Current Goal Review Status");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Current Goal Review Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Next Goal Review Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Previous Goal Review Date/Time");
                                  this.add(TQ.class, false, 1, 200, new Object[]{ getMessage() }, "Goal Review Interval");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Goal Evaluation");
                                  this.add(ST.class, false, 0, 300, new Object[]{ getMessage() }, "Goal Evaluation Comment");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Goal Life Cycle Status");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Goal Life Cycle Status Date/Time");
                                  this.add(CWE.class, false, 0, 705, new Object[]{ getMessage() }, "Goal Target Type");
          ...
          Log.e(Constants.TAG, "Unexpected error creating GOL - this is probably a bug in the source code generator.", e);
       }
    }
