...
public class ARV extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CNE.class, true, 1, 705, new Object[]{ getMessage() }, "Access Restriction Action Code");
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Access Restriction Value");
                                  this.add(CWE.class, false, 0, 705, new Object[]{ getMessage() }, "Access Restriction Reason");
                                  this.add(ST.class, false, 0, 250, new Object[]{ getMessage() }, "Special Access Restriction Instructions");
                                  this.add(DR.class, false, 1, 49, new Object[]{ getMessage() }, "Access Restriction Date Range");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating ARV - this is probably a bug in the source code generator.", e);
       }
    }
