...
public class ILT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, true, 1, 250, new Object[]{ getMessage() }, "Inventory Lot Number");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Inventory Expiration Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Inventory Received Date");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Inventory On Hand Date");
          ...
          Log.e(Constants.TAG, "Unexpected error creating ILT - this is probably a bug in the source code generator.", e);
       }
    }
