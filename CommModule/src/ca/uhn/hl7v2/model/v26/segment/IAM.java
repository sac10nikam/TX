...
public class IAM extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Sensitivity to Causative Agent Code");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Allergen Group Code/Mnemonic/Description");
                                  ...
                                  this.add(DTM.class, false, 1, 8, new Object[]{ getMessage() }, "Reported Date/Time");
                                  this.add(XPN.class, false, 1, 250, new Object[]{ getMessage() }, "Reported By");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Relationship to Patient Code");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Alert Device Code");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Allergy Clinical Status Code");
                                  ...
                                  this.add(DTM.class, false, 1, 8, new Object[]{ getMessage() }, "Statused at Date/Time");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating IAM - this is probably a bug in the source code generator.", e);
       }
    }
