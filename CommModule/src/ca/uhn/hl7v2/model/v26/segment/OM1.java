 ...
 * <ul>
     ...
     * <li>OM1-7: Other Service/Test/Observation IDs for the Observation (CWE) <b>optional </b>
     ...
     * <li>OM1-31: Observations Required to Interpret the Observation (CWE) <b>optional </b>
     * <li>OM1-32: Interpretation of Observations (TX) <b>optional </b>
     * <li>OM1-33: Contraindications to Observations (CWE) <b>optional </b>
     ...
     * <li>OM1-36: Fixed Canned Message (CWE) <b>optional </b>
...
public class OM1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Producer's Service/Test/Observation ID");
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Producer ID");
                                  this.add(TX.class, false, 1, 200, new Object[]{ getMessage() }, "Observation Description");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Other Service/Test/Observation IDs for the Observation");
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Identity of Instrument Used to Perform this Study");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Coded Representation of Method");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Portable Device Indicator");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Observation Producing Department/Section");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Report Subheader");
                                  this.add(ST.class, false, 1, 20, new Object[]{ getMessage() }, "Report Display Order");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date/Time Stamp for any change in Definition for the Observation");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Effective Date/Time of Change");
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Outside Site(s) Where Observation may be Performed");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Observations Required to Interpret the Observation");
                                  this.add(TX.class, false, 1, 65536, new Object[]{ getMessage() }, "Interpretation of Observations");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Contraindications to Observations");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Reflex Tests/Observations");
                                  this.add(TX.class, false, 1, 80, new Object[]{ getMessage() }, "Rules that Trigger Reflex Testing");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Fixed Canned Message");
                                  this.add(TX.class, false, 1, 200, new Object[]{ getMessage() }, "Patient Preparation");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Procedure Medication");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Kind of Quantity Observed");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Point Versus Interval");
                                  this.add(TX.class, false, 1, 200, new Object[]{ getMessage() }, "Challenge Information");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Relationship Modifier");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Target Anatomic Site Of Test");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Modality Of Imaging Measurement");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating OM1 - this is probably a bug in the source code generator.", e);
       }
    }
