 ...
 * <ul>
     ...
     * <li>RQD-7: Cost Center Account Number (IS) <b>optional </b>
...
public class RQD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Item Code - Internal");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Item Code - External");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Hospital Item Code");
                                  this.add(NM.class, false, 1, 6, new Object[]{ getMessage() }, "Requisition Quantity");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requisition Unit of Measure");
                                              this.add(IS.class, false, 1, 30, new Object[]{ getMessage(), new Integer(319) }, "Cost Center Account Number");
                                              this.add(IS.class, false, 1, 30, new Object[]{ getMessage(), new Integer(320) }, "Item Natural Account Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Deliver To ID");
                                  this.add(DT.class, false, 1, 8, new Object[]{ getMessage() }, "Date Needed");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating RQD - this is probably a bug in the source code generator.", e);
       }
    }
