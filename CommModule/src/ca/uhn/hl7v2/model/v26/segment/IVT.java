...
public class IVT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EI.class, true, 1, 250, new Object[]{ getMessage() }, "Inventory Location Identifier");
                                  this.add(ST.class, false, 1, 999, new Object[]{ getMessage() }, "Inventory Location Name");
                                  this.add(EI.class, false, 1, 250, new Object[]{ getMessage() }, "Source Location Identifier");
                                  this.add(ST.class, false, 1, 999, new Object[]{ getMessage() }, "Source Location Name");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Item Status");
                                  this.add(EI.class, false, 0, 250, new Object[]{ getMessage() }, "Bin Location Identifier");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Order Packaging");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Issue Packaging");
                                  this.add(EI.class, false, 1, 16, new Object[]{ getMessage() }, "Default Inventory Asset Account");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Patient Chargeable Indicator");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Transaction Code");
                                  this.add(CP.class, false, 1, 12, new Object[]{ getMessage() }, "Transaction amount - unit");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Item Importance Code");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Stocked Item Indicator");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Consignment Item Indicator");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Reusable Item Indicator");
                                  this.add(CP.class, false, 1, 12, new Object[]{ getMessage() }, "Reusable Cost");
                                  this.add(EI.class, false, 0, 250, new Object[]{ getMessage() }, "Substitute Item Identifier");
                                  this.add(EI.class, false, 1, 250, new Object[]{ getMessage() }, "Latex-Free Substitute Item Identifier");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Recommended Reorder Theory");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Recommended Safety Stock Days");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Recommended Maximum Days Inventory");
                                  this.add(NM.class, false, 1, 8, new Object[]{ getMessage() }, "Recommended Order Point");
                                  this.add(NM.class, false, 1, 8, new Object[]{ getMessage() }, "Recommended Order Amount");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Operating Room Par Level Indicator");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating IVT - this is probably a bug in the source code generator.", e);
       }
    }
