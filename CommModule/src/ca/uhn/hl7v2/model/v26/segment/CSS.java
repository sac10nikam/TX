 ...
 * <ul>
     * <li>CSS-1: Study Scheduled Time Point (CWE) <b> </b>
     * <li>CSS-2: Study Scheduled Patient Time Point (DTM) <b>optional </b>
     * <li>CSS-3: Study Quality Control Codes (CWE) <b>optional repeating</b>
 * </ul>
 */
public class CSS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 705, new Object[]{ getMessage() }, "Study Scheduled Time Point");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Study Scheduled Patient Time Point");
                                  this.add(CWE.class, false, 3, 705, new Object[]{ getMessage() }, "Study Quality Control Codes");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating CSS - this is probably a bug in the source code generator.", e);
       }
    }
