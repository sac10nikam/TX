...
public class ORG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Organization Unit Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Organization Unit Type Code");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Health Care Provider Type Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Health Care Provider Classification Code");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Health Care Provider Area of Specialization Code");
          ...
          Log.e(Constants.TAG, "Unexpected error creating ORG - this is probably a bug in the source code generator.", e);
       }
    }
