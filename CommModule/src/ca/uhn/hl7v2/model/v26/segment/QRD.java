...
public class QRD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Query Date/Time");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Deferred Response Date/Time");
                                  ...
                                  this.add(CWE.class, true, 0, 250, new Object[]{ getMessage() }, "What Subject Filter");
                                  this.add(CWE.class, true, 0, 250, new Object[]{ getMessage() }, "What Department Data Code");
          ...
          Log.e(Constants.TAG, "Unexpected error creating QRD - this is probably a bug in the source code generator.", e);
       }
    }
