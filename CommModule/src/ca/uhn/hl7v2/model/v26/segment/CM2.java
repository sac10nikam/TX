...
public class CM2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Scheduled Time Point");
                                  this.add(ST.class, false, 1, 300, new Object[]{ getMessage() }, "Description of Time Point");
                                  this.add(CWE.class, true, 200, 250, new Object[]{ getMessage() }, "Events Scheduled This Time Point");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating CM2 - this is probably a bug in the source code generator.", e);
       }
    }
