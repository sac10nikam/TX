...
public class SCD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(TM.class, false, 1, 16, new Object[]{ getMessage() }, "Cycle Start Time");
                                  this.add(NM.class, false, 1, 16, new Object[]{ getMessage() }, "Cycle Count");
                                  this.add(CQ.class, false, 1, 36, new Object[]{ getMessage() }, "Temp Max");
                                  this.add(CQ.class, false, 1, 36, new Object[]{ getMessage() }, "Temp Min");
                                  this.add(NM.class, false, 1, 16, new Object[]{ getMessage() }, "Load Number");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Condition Time");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Sterilize Time");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Exhaust Time");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Total Cycle Time");
                                  this.add(CWE.class, false, 1, 4, new Object[]{ getMessage() }, "Device Status");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Cycle Start Date/Time");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Dry Time");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Leak Rate");
                                  this.add(CQ.class, false, 1, 36, new Object[]{ getMessage() }, "Control Temperature");
                                  this.add(CQ.class, false, 1, 36, new Object[]{ getMessage() }, "Sterilizer Temperature");
                                  this.add(TM.class, false, 1, 16, new Object[]{ getMessage() }, "Cycle Complete Time");
                                  this.add(CQ.class, false, 1, 36, new Object[]{ getMessage() }, "Under Temperature");
                                  this.add(CQ.class, false, 1, 36, new Object[]{ getMessage() }, "Over Temperature");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Abort Cycle");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Alarm");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Long in Charge Phase");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Long in Exhaust Phase");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Long in Fast Exhaust Phase");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Reset");
                                  this.add(XCN.class, false, 1, 15, new Object[]{ getMessage() }, "Operator - Unload");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Door Open");
                                  this.add(CNE.class, false, 1, 4, new Object[]{ getMessage() }, "Reading Failure");
                                  this.add(CWE.class, false, 1, 3, new Object[]{ getMessage() }, "Cycle Type");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Thermal Rinse Time");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Wash Time");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Injection Rate");
                                  this.add(CNE.class, false, 1, 705, new Object[]{ getMessage() }, "Procedure Code");
                                  this.add(CX.class, false, 0, 250, new Object[]{ getMessage() }, "Patient Identifier List");
                                  this.add(XCN.class, false, 1, 250, new Object[]{ getMessage() }, "Attending Doctor");
                                  this.add(SN.class, false, 1, 36, new Object[]{ getMessage() }, "Dilution Factor");
                                  this.add(CQ.class, false, 1, 16, new Object[]{ getMessage() }, "Fill Time");
                                  this.add(CQ.class, false, 1, 36, new Object[]{ getMessage() }, "Inlet Temperature");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating SCD - this is probably a bug in the source code generator.", e);
       }
    }
