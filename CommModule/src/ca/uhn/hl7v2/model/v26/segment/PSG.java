...
public class PSG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Provider Product/Service Group Number");
                                  this.add(EI.class, false, 1, 73, new Object[]{ getMessage() }, "Payer Product/Service Group Number");
                                  ...
                                  this.add(CP.class, true, 1, 254, new Object[]{ getMessage() }, "Product/Service Group Billed Amount");
                                  this.add(ST.class, true, 1, 254, new Object[]{ getMessage() }, "Product/Service Group Description");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PSG - this is probably a bug in the source code generator.", e);
       }
    }
