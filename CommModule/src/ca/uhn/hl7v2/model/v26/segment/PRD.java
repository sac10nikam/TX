...
public class PRD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 0, 705, new Object[]{ getMessage() }, "Provider Role");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Effective Start Date of Provider Role");
                                  this.add(DTM.class, false, 0, 24, new Object[]{ getMessage() }, "Effective End Date of Provider Role");
                                  this.add(XON.class, false, 1, 250, new Object[]{ getMessage() }, "Provider Organization Name and Identifier");
                                  this.add(XAD.class, false, 0, 60, new Object[]{ getMessage() }, "Provider Organization Address");
                                  this.add(PL.class, false, 0, 60, new Object[]{ getMessage() }, "Provider Organization Location Information");
                                  this.add(XTN.class, false, 0, 250, new Object[]{ getMessage() }, "Provider Organization Communication Information");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Provider Organization Method of Contact");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PRD - this is probably a bug in the source code generator.", e);
       }
    }
