...
public class IPC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 427, new Object[]{ getMessage() }, "Accession Identifier");
                                  ...
                                  this.add(CWE.class, false, 1, 16, new Object[]{ getMessage() }, "Modality");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Protocol Code");
                                  this.add(EI.class, false, 1, 22, new Object[]{ getMessage() }, "Scheduled Station Name");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Scheduled Procedure Step Location");
                                  this.add(ST.class, false, 1, 16, new Object[]{ getMessage() }, "Scheduled Station AE Title");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating IPC - this is probably a bug in the source code generator.", e);
       }
    }
