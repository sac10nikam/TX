 ...
 * <ul>
     ...
     * <li>PES-9: Sender Aware Date/Time (DTM) <b>optional </b>
     * <li>PES-10: Event Report Date (DTM) <b> </b>
...
public class PES extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(XON.class, false, 0, 567, new Object[]{ getMessage() }, "Sender Organization Name");
                                  this.add(XCN.class, false, 0, 3220, new Object[]{ getMessage() }, "Sender Individual Name");
                                  this.add(XAD.class, false, 0, 2915, new Object[]{ getMessage() }, "Sender Address");
                                  this.add(XTN.class, false, 0, 2743, new Object[]{ getMessage() }, "Sender Telephone");
                                  this.add(EI.class, false, 1, 427, new Object[]{ getMessage() }, "Sender Event Identifier");
                                  this.add(NM.class, false, 1, 16, new Object[]{ getMessage() }, "Sender Sequence Number");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Sender Aware Date/Time");
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Event Report Date");
          ...
          Log.e(Constants.TAG, "Unexpected error creating PES - this is probably a bug in the source code generator.", e);
       }
    }
