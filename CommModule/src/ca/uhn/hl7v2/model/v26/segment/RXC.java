...
public class RXC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Component Code");
                                  this.add(NM.class, true, 1, 20, new Object[]{ getMessage() }, "Component Amount");
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Component Units");
                                  this.add(NM.class, false, 1, 20, new Object[]{ getMessage() }, "Component Strength");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Component Strength Units");
          ...
          Log.e(Constants.TAG, "Unexpected error creating RXC - this is probably a bug in the source code generator.", e);
       }
    }
