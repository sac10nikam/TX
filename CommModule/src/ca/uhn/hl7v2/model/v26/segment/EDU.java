 ...
 * <ul>
     ...
     * <li>EDU-7: School Type Code (CWE) <b>optional </b>
...
public class EDU extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "School Type Code");
          ...
          Log.e(Constants.TAG, "Unexpected error creating EDU - this is probably a bug in the source code generator.", e);
       }
    }
