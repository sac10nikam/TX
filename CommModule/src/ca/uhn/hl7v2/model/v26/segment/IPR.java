...
public class IPR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "IPR Identifier");
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Provider Cross Reference Identifier");
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Payer Cross Reference Identifier");
                                  this.add(CWE.class, true, 1, 177, new Object[]{ getMessage() }, "IPR Status");
                                  this.add(DTM.class, true, 1, 26, new Object[]{ getMessage() }, "IPR Date/Time");
                                  this.add(CP.class, false, 1, 254, new Object[]{ getMessage() }, "Adjudicated/Paid Amount");
                                  this.add(DTM.class, false, 1, 26, new Object[]{ getMessage() }, "Expected Payment Date/Time");
                                  this.add(ST.class, true, 1, 10, new Object[]{ getMessage() }, "IPR Checksum");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating IPR - this is probably a bug in the source code generator.", e);
       }
    }
