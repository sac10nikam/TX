...
public class EQU extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 427, new Object[]{ getMessage() }, "Equipment Instance Identifier");
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Event Date/Time");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Equipment State");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Local/Remote Control State");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Alert Level");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating EQU - this is probably a bug in the source code generator.", e);
       }
    }
