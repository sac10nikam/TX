...
public class ODS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 20, 250, new Object[]{ getMessage() }, "Diet, Supplement, or Preference Code");
                                  this.add(ST.class, false, 2, 80, new Object[]{ getMessage() }, "Text Instruction");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating ODS - this is probably a bug in the source code generator.", e);
       }
    }
