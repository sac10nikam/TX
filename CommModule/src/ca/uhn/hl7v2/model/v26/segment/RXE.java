 ...
 * <ul>
     ...
     * <li>RXE-21: Pharmacy/Treatment Supplier's Special Dispensing Instructions (CWE) <b>optional repeating</b>
...
public class RXE extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(TQ.class, false, 1, 0, new Object[]{ getMessage() }, "Quantity/Timing");
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Give Code");
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Give Units");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Give Dosage Form");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Provider's Administration Instructions");
                                  this.add(LA1.class, false, 1, 0, new Object[]{ getMessage() }, "Deliver-To Location");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Dispense Units");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "D/T of Most Recent Refill or Dose Dispensed");
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Pharmacy/Treatment Supplier's Special Dispensing Instructions");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Give Rate Units");
                                  this.add(NM.class, false, 1, 20, new Object[]{ getMessage() }, "Give Strength");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Give Strength Units");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Give Indication");
                                  this.add(NM.class, false, 1, 20, new Object[]{ getMessage() }, "Dispense Package Size");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Dispense Package Size Unit");
                                              this.add(ID.class, false, 1, 2, new Object[]{ getMessage(), new Integer(321) }, "Dispense Package Method");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Supplementary Code");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Original Order Date/Time");
          ...
          Log.e(Constants.TAG, "Unexpected error creating RXE - this is probably a bug in the source code generator.", e);
       }
    }
