...
public class MSA extends AbstractSegment {
	private static final long serialVersionUID = -1106330776106198269L;
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Text Message");
                                  ...
                                  this.add(CNE.class, false, 1, 0, new Object[]{ getMessage() }, "Error Condition");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Message Waiting Number");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(520) }, "Message Waiting Priority");
       } catch(HL7Exception e) {
    	   Log.e(Constants.TAG, "Unexpected error creating MSA - this is probably a bug in the source code generator.");
       }
    }
