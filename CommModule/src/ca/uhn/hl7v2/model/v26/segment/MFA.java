...
public class MFA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Event Completion Date/Time");
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "MFN Record Level Error Return");
          ...
          Log.e(Constants.TAG, "Unexpected error creating MFA - this is probably a bug in the source code generator.", e);
       }
    }
