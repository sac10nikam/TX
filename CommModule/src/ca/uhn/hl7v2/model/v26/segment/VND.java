...
public class VND extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 2, new Object[]{ getMessage() }, "Set Id - VND");
                                  this.add(EI.class, true, 1, 250, new Object[]{ getMessage() }, "Vendor Identifier");
                                  this.add(ST.class, false, 1, 999, new Object[]{ getMessage() }, "Vendor Name");
                                  this.add(EI.class, false, 1, 20, new Object[]{ getMessage() }, "Vendor Catalog Number");
                                  this.add(CNE.class, false, 1, 1, new Object[]{ getMessage() }, "Primary Vendor Indicator");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating VND - this is probably a bug in the source code generator.", e);
       }
    }
