...
public class NTE extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Comment Type");
    	   ...
    	   Log.e(Constants.TAG, "Unexpected error creating NTE - this is probably a bug in the source code generator.", e);
       }
    }
