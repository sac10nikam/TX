...
public class ERR extends AbstractSegment {
	private static final long serialVersionUID = -2709971290670058334L;
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ELD.class, false, 0, 0, new Object[]{ getMessage() }, "Error Code and Location");
          ...
          Log.e(Constants.TAG, "Unexpected error creating ERR - this is probably a bug in the source code generator.");
       }
    }
