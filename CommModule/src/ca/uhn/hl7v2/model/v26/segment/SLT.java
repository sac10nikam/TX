...
public class SLT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EI.class, false, 1, 250, new Object[]{ getMessage() }, "Item Identifier");
                                  this.add(ST.class, false, 1, 30, new Object[]{ getMessage() }, "Bar Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating SLT - this is probably a bug in the source code generator.", e);
       }
    }
