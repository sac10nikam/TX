 ...
 * <ul>
     ...
     * <li>IN1-2: Insurance Plan ID (CWE) <b> </b>
     ...
     * <li>IN1-38: Policy Limit - Amount (NULLDT) <b>optional </b>
     * <li>IN1-39: Policy Limit - Days (NM) <b>optional </b>
     * <li>IN1-40: Room Rate - Semi-Private (NULLDT) <b>optional </b>
     * <li>IN1-41: Room Rate - Private (NULLDT) <b>optional </b>
...
public class IN1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Insurance Plan ID");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Insured's Relationship To Patient");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Insured's Date Of Birth");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Verification Date/Time");
                                  ...
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Delay Before L.R. Day");
                                              this.add(IS.class, false, 1, 20, new Object[]{ getMessage(), new Integer(42) }, "Company Plan Code");
                                  ...
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Policy Limit - Amount");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Policy Limit - Days");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Room Rate - Semi-Private");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Room Rate - Private");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Insured's Employment Status");
          ...
          Log.e(Constants.TAG, "Unexpected error creating IN1 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public NULLDT getPolicyLimitAmount() { 
		NULLDT retVal = this.getTypedField(38, 0);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 37: return new NULLDT(getMessage());
          case 38: return new NM(getMessage());
          case 39: return new NULLDT(getMessage());
          case 40: return new NULLDT(getMessage());
