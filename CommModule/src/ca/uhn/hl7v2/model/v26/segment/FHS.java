...
public class FHS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "File Creation Date/Time");
                                  ...
                                  this.add(HD.class, false, 1, 227, new Object[]{ getMessage() }, "File Sending Network Address");
                                  this.add(HD.class, false, 1, 227, new Object[]{ getMessage() }, "File Receiving Network Address");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating FHS - this is probably a bug in the source code generator.", e);
       }
    }
