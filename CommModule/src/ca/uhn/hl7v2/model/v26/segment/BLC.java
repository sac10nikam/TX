...
public class BLC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Blood Product Code");
                                  this.add(CQ.class, false, 1, 267, new Object[]{ getMessage() }, "Blood Amount");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating BLC - this is probably a bug in the source code generator.", e);
       }
    }
