...
public class RXD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Dispense/Give Code");
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Date/Time Dispensed");
                                  this.add(NM.class, true, 1, 20, new Object[]{ getMessage() }, "Actual Dispense Amount");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Actual Dispense Units");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Actual Dosage Form");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Actual Strength Unit");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Initiating Location");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Packaging/Assembly Location");
          ...
          Log.e(Constants.TAG, "Unexpected error creating RXD - this is probably a bug in the source code generator.", e);
       }
    }
