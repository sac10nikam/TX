...
public class ADJ extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Provider Adjustment Number");
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Payer Adjustment Number");
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Adjustment Sequence Number");
                                              this.add(IS.class, true, 1, 4, new Object[]{ getMessage(), 564 }, "Adjustment Category");
                                  this.add(CP.class, false, 1, 254, new Object[]{ getMessage() }, "Adjustment Amount");
                                  this.add(CQ.class, false, 1, 222, new Object[]{ getMessage() }, "Adjustment Quantity");
                                  this.add(CWE.class, false, 1, 211, new Object[]{ getMessage() }, "Adjustment Reason PA");
                                  this.add(ST.class, false, 1, 250, new Object[]{ getMessage() }, "Adjustment Description");
                                  this.add(NM.class, false, 1, 250, new Object[]{ getMessage() }, "Original Value");
                                  this.add(NM.class, false, 1, 250, new Object[]{ getMessage() }, "Substitute Value");
                                              this.add(IS.class, false, 1, 4, new Object[]{ getMessage(), 569 }, "Adjustment Action");
                                  this.add(EI.class, false, 1, 73, new Object[]{ getMessage() }, "Provider Adjustment Number Cross Reference");
                                  this.add(EI.class, false, 1, 73, new Object[]{ getMessage() }, "Provider Product/Service Line Item Number Cross Reference");
                                  this.add(DTM.class, true, 1, 26, new Object[]{ getMessage() }, "Adjustment Date");
                                  this.add(XON.class, false, 1, 183, new Object[]{ getMessage() }, "Responsible Organization");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating ADJ - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 3: return new IS(getMessage(), 564);
          ...
          case 10: return new IS(getMessage(), 569);
