...
public class RFI extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Request Date");
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Response Due Date");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Patient Consent");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Date Additional Information was submitted");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating RFI - this is probably a bug in the source code generator.", e);
       }
    }
