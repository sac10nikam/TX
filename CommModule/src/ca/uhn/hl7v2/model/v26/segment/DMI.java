...
public class DMI extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(NR.class, false, 1, 7, new Object[]{ getMessage() }, "Lower and Upper Trim Points");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Average Length of Stay");
                                  this.add(NM.class, false, 1, 7, new Object[]{ getMessage() }, "Relative Weight");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating DMI - this is probably a bug in the source code generator.", e);
       }
    }
