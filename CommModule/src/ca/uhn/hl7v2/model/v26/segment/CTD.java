 ...
 * <ul>
     * <li>CTD-1: Contact Role (CWE) <b> repeating</b>
     ...
     * <li>CTD-6: Preferred Method of Contact (CWE) <b>optional </b>
...
public class CTD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 0, 705, new Object[]{ getMessage() }, "Contact Role");
          ...
          Log.e(Constants.TAG, "Unexpected error creating CTD - this is probably a bug in the source code generator.");
       }
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CWE getCtd1_ContactRole(int rep) { 
		CWE retVal = this.getTypedField(1, rep);
		return retVal;
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE insertCtd1_ContactRole(int rep) throws HL7Exception { 
        return (CWE) super.insertRepetition(1, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE removeCtd1_ContactRole(int rep) throws HL7Exception { 
        return (CWE) super.removeRepetition(1, rep);
    }
