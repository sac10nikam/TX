 ...
 * <ul>
     ...
     * <li>PSH-3: Report Date (DTM) <b> </b>
     * <li>PSH-4: Report Interval Start Date (DTM) <b>optional </b>
     * <li>PSH-5: Report Interval End Date (DTM) <b>optional </b>
...
public class PSH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, true, 1, 24, new Object[]{ getMessage() }, "Report Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Report Interval Start Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Report Interval End Date");
                                  this.add(CQ.class, false, 1, 722, new Object[]{ getMessage() }, "Quantity Manufactured");
                                  this.add(CQ.class, false, 1, 722, new Object[]{ getMessage() }, "Quantity Distributed");
                                  ...
                                  this.add(CQ.class, false, 1, 722, new Object[]{ getMessage() }, "Quantity in Use");
                                  ...
                                  this.add(NM.class, false, 8, 16, new Object[]{ getMessage() }, "Number of Product Experience Reports Filed by Facility");
                                  this.add(NM.class, false, 8, 16, new Object[]{ getMessage() }, "Number of Product Experience Reports Filed by Distributor");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PSH - this is probably a bug in the source code generator.", e);
       }
    }
