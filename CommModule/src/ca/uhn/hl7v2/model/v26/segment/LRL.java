...
public class LRL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Location Relationship ID");
          ...
          Log.e(Constants.TAG, "Unexpected error creating LRL - this is probably a bug in the source code generator.", e);
       }
    }
