...
public class OM4 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Container Units");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Specimen");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Additive");
          ...
          Log.e(Constants.TAG, "Unexpected error creating OM4 - this is probably a bug in the source code generator.", e);
       }
    }
