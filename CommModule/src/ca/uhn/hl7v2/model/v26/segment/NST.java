...
public class NST extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Statistics Start");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Statistics End");
          ...
          Log.e(Constants.TAG, "Unexpected error creating NST - this is probably a bug in the source code generator.", e);
       }
    }
