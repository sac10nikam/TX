...
public class QRI extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Algorithm Descriptor");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating QRI - this is probably a bug in the source code generator.", e);
       }
    }
