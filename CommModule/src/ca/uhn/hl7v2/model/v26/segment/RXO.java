...
public class RXO extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requested Give Code");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requested Give Units");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requested Dosage Form");
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Provider's Pharmacy/Treatment Instructions");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requested Dispense Code");
                                  this.add(NM.class, false, 1, 20, new Object[]{ getMessage() }, "Requested Dispense Amount");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requested Dispense Units");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requested Give Strength Units");
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Requested Give Rate Units");
                                  ...
                                  this.add(EI.class, false, 1, 60, new Object[]{ getMessage() }, "Medication Instance Identifier");
                                  this.add(EI.class, false, 1, 60, new Object[]{ getMessage() }, "Segment Instance Identifier");
                                  this.add(CNE.class, false, 1, 2, new Object[]{ getMessage() }, "Mood Code");
          ...
          Log.e(Constants.TAG, "Unexpected error creating RXO - this is probably a bug in the source code generator.", e);
       }
    }
