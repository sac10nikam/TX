...
public class LCC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 0, 250, new Object[]{ getMessage() }, "Accommodation Type");
                                  this.add(CWE.class, true, 0, 250, new Object[]{ getMessage() }, "Charge Code");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating LCC - this is probably a bug in the source code generator.", e);
       }
    }
