...
public class RF1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Referral Status");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Referral Priority");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Referral Type");
                                  this.add(CWE.class, false, 0, 705, new Object[]{ getMessage() }, "Referral Disposition");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Referral Category");
                                  this.add(EI.class, true, 1, 30, new Object[]{ getMessage() }, "Originating Referral Identifier");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Effective Date");
                                  ...
                                  this.add(CWE.class, false, 0, 705, new Object[]{ getMessage() }, "Referral Reason");
                                  this.add(EI.class, false, 0, 30, new Object[]{ getMessage() }, "External Referral Identifier");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Referral Documentation Completion Status");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating RF1 - this is probably a bug in the source code generator.", e);
       }
    }
