...
public class PSS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Provider Product/Service Section Number");
                                  this.add(EI.class, false, 1, 73, new Object[]{ getMessage() }, "Payer Product/Service Section Number");
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Product/Service Section Sequence Number");
                                  this.add(CP.class, true, 1, 254, new Object[]{ getMessage() }, "Billed Amount");
                                  this.add(ST.class, true, 1, 254, new Object[]{ getMessage() }, "Section Description or Heading");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PSS - this is probably a bug in the source code generator.", e);
       }
    }
