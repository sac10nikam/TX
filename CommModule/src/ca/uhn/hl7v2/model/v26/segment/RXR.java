 ...
 * <ul>
     * <li>RXR-1: Route (CWE) <b> </b>
     * <li>RXR-2: Administration Site (CWE) <b>optional </b>
     * <li>RXR-3: Administration Device (CWE) <b>optional </b>
     * <li>RXR-4: Administration Method (CWE) <b>optional </b>
     * <li>RXR-5: Routing Instruction (CWE) <b>optional </b>
...
public class RXR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Route");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Administration Site");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Administration Device");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Administration Method");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Routing Instruction");
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Administration Site Modifier");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating RXR - this is probably a bug in the source code generator.", e);
       }
    }
