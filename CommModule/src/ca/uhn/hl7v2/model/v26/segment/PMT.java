...
public class PMT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Payment/Remittance Advice Number");
                                  this.add(DTM.class, true, 1, 26, new Object[]{ getMessage() }, "Payment/Remittance Effective Date/Time");
                                  this.add(DTM.class, true, 1, 26, new Object[]{ getMessage() }, "Payment/Remittance Expiration Date/Time");
                                  this.add(CWE.class, true, 1, 177, new Object[]{ getMessage() }, "Payment Method");
                                  this.add(DTM.class, true, 1, 26, new Object[]{ getMessage() }, "Payment/Remittance Date/Time");
                                  this.add(CP.class, true, 1, 254, new Object[]{ getMessage() }, "Payment/Remittance Amount");
                                  this.add(EI.class, false, 1, 15, new Object[]{ getMessage() }, "Check Number");
                                  this.add(XON.class, false, 1, 6, new Object[]{ getMessage() }, "Payee Bank Identification");
                                  this.add(ST.class, false, 1, 4, new Object[]{ getMessage() }, "Payee Transit Number");
                                  this.add(CX.class, false, 1, 20, new Object[]{ getMessage() }, "Payee Bank Account ID");
                                  this.add(XON.class, true, 1, 183, new Object[]{ getMessage() }, "Payment Organization");
                                  this.add(ST.class, false, 1, 100, new Object[]{ getMessage() }, "ESR-Code-Line");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PMT - this is probably a bug in the source code generator.", e);
       }
    }
