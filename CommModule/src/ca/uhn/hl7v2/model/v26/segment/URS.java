 ...
 * <ul>
     ...
     * <li>URS-2: R/U When Data Start Date/Time (DTM) <b>optional </b>
     * <li>URS-3: R/U When Data End Date/Time (DTM) <b>optional </b>
...
public class URS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "R/U When Data Start Date/Time");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "R/U When Data End Date/Time");
                                  ...
                                  this.add(TQ.class, false, 1, 0, new Object[]{ getMessage() }, "R/U Quantity/Timing Qualifier");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating URS - this is probably a bug in the source code generator.", e);
       }
    }
