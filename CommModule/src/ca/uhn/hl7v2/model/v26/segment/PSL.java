...
public class PSL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 73, new Object[]{ getMessage() }, "Provider Product/Service Line Item Number");
                                  this.add(EI.class, false, 1, 73, new Object[]{ getMessage() }, "Payer Product/Service Line Item Number");
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Product/Service Line Item Sequence Number");
                                  this.add(EI.class, false, 1, 20, new Object[]{ getMessage() }, "Provider Tracking ID");
                                  this.add(EI.class, false, 1, 20, new Object[]{ getMessage() }, "Payer Tracking ID");
                                  this.add(CWE.class, true, 1, 2, new Object[]{ getMessage() }, "Product/Service Line Item Status");
                                  this.add(CWE.class, true, 1, 177, new Object[]{ getMessage() }, "Product/Service Code");
                                  this.add(CWE.class, false, 1, 177, new Object[]{ getMessage() }, "Product/Service Code Modifier");
                                  this.add(ST.class, false, 1, 80, new Object[]{ getMessage() }, "Product/Service Code Description");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Product/Service Effective Date");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Product/Service Expiration Date");
                                  this.add(CQ.class, false, 1, 222, new Object[]{ getMessage() }, "Product/Service Quantity");
                                  this.add(CP.class, false, 1, 254, new Object[]{ getMessage() }, "Product/Service Unit Cost");
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Number of Items per Unit");
                                  this.add(CP.class, false, 1, 254, new Object[]{ getMessage() }, "Product/Service Gross Amount");
                                  this.add(CP.class, false, 1, 254, new Object[]{ getMessage() }, "Product/Service Billed Amount");
                                              this.add(IS.class, false, 1, 10, new Object[]{ getMessage(), new Integer(561) }, "Product/Service Clarification Code Type");
                                  this.add(ST.class, false, 1, 40, new Object[]{ getMessage() }, "Product/Service Clarification Code Value");
                                  this.add(EI.class, false, 1, 73, new Object[]{ getMessage() }, "Health Document Reference Identifier");
                                              this.add(IS.class, false, 1, 10, new Object[]{ getMessage(), new Integer(562) }, "Processing Consideration Code");
                                              this.add(ID.class, true, 1, 2, new Object[]{ getMessage(), new Integer(532) }, "Restricted Disclosure Indicator");
                                  this.add(CWE.class, false, 1, 177, new Object[]{ getMessage() }, "Related Product/Service Code Indicator");
                                  this.add(CP.class, false, 1, 254, new Object[]{ getMessage() }, "Product/Service Amount for Physician");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Product/Service Cost Factor");
                                  this.add(CX.class, false, 1, 250, new Object[]{ getMessage() }, "Cost Center");
                                  this.add(DR.class, false, 1, 49, new Object[]{ getMessage() }, "Billing Period");
                                  this.add(NM.class, false, 1, 5, new Object[]{ getMessage() }, "Days without Billing");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Session-No");
                                  this.add(XCN.class, false, 1, 20, new Object[]{ getMessage() }, "Executing Physician ID");
                                  this.add(XCN.class, false, 1, 20, new Object[]{ getMessage() }, "Responsible Physician ID");
                                  this.add(CWE.class, false, 1, 10, new Object[]{ getMessage() }, "Role Executing Physician");
                                  this.add(CWE.class, false, 1, 10, new Object[]{ getMessage() }, "Medical Role Executing Physician");
                                  this.add(CWE.class, false, 1, 3, new Object[]{ getMessage() }, "Side of body");
                                  this.add(NM.class, false, 1, 6, new Object[]{ getMessage() }, "Number of TP's PP");
                                  this.add(CP.class, false, 1, 6, new Object[]{ getMessage() }, "TP-Value PP");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Internal Scaling Factor PP");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "External Scaling Factor PP");
                                  this.add(CP.class, false, 1, 7, new Object[]{ getMessage() }, "Amount PP");
                                  this.add(NM.class, false, 1, 6, new Object[]{ getMessage() }, "Number of TP's Technical Part");
                                  this.add(CP.class, false, 1, 6, new Object[]{ getMessage() }, "TP-Value Technical Part");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "Internal Scaling Factor Technical Part");
                                  this.add(NM.class, false, 1, 4, new Object[]{ getMessage() }, "External Scaling Factor Technical Part");
                                  this.add(CP.class, false, 1, 7, new Object[]{ getMessage() }, "Amount Technical Part");
                                  this.add(CP.class, false, 1, 8, new Object[]{ getMessage() }, "Total Amount Professional Part + Technical Part");
                                  this.add(NM.class, false, 1, 3, new Object[]{ getMessage() }, "VAT-Rate");
                                  ...
                                  this.add(ST.class, false, 1, 255, new Object[]{ getMessage() }, "Comment");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating PSL - this is probably a bug in the source code generator.", e);
       }
    }
