...
public class QAK extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 250, new Object[]{ getMessage() }, "Message Query Name");
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Hit Count Total");
          ...
          Log.e(Constants.TAG, "Unexpected error creating QAK - this is probably a bug in the source code generator.", e);
       }
    }
