...
public class RCP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CNE.class, false, 1, 250, new Object[]{ getMessage() }, "Response Modality");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Execution and Delivery Time");
                                  ...
                                  this.add(SRT.class, false, 0, 512, new Object[]{ getMessage() }, "Sort-by Field");
                                              this.add(ID.class, false, 0, 256, new Object[]{ getMessage(), new Integer(391) }, "Segment group inclusion");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating RCP - this is probably a bug in the source code generator.", e);
       }
    }
