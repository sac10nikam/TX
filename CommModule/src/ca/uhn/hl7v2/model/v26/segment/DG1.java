 ...
 * <ul>
     ...
     * <li>DG1-25: DRG Diagnosis Determination Status (IS) <b>optional </b>
     * <li>DG1-26: Present On Admission (POA) Indicator (IS) <b>optional </b>
 * </ul>
 */
public class DG1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 250, new Object[]{ getMessage() }, "Diagnosis Code - DG1");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Diagnosis Description");
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Diagnosis Date/Time");
                                              this.add(IS.class, true, 1, 2, new Object[]{ getMessage(), new Integer(52) }, "Diagnosis Type");
                                  this.add(CNE.class, false, 1, 1, new Object[]{ getMessage() }, "Major Diagnostic Category");
                                  ...
                                  this.add(DTM.class, false, 1, 24, new Object[]{ getMessage() }, "Attestation Date/Time");
                                  ...
                                  this.add(EI.class, false, 1, 427, new Object[]{ getMessage() }, "Parent Diagnosis");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "DRG CCL Value Code");
                                              this.add(ID.class, false, 1, 20, new Object[]{ getMessage(), new Integer(136) }, "DRG Grouping Usage");
                                              this.add(IS.class, false, 1, 20, new Object[]{ getMessage(), new Integer(731) }, "DRG Diagnosis Determination Status");
                                              this.add(IS.class, false, 1, 1, new Object[]{ getMessage(), new Integer(895) }, "Present On Admission (POA) Indicator");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating DG1 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 24: return new IS(getMessage(), new Integer( 731 ));
          case 25: return new IS(getMessage(), new Integer( 895 ));
          default: return null;
       }
   }
