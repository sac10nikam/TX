...
public class CTI extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Study Phase Identifier");
                                  this.add(CWE.class, false, 1, 705, new Object[]{ getMessage() }, "Study Scheduled Time Point");
       } catch(HL7Exception e) {
          Log.e(Constants.TAG, "Unexpected error creating CTI - this is probably a bug in the source code generator.");
       }
    }
